    ...
    <>
      ...
      <section id="shorten" class="relative bg-gray-100">
        ...
        <div class="max-w-4xl mx-auto p-6 space-y-6">
          ...
          <form
            id="link-form"
            class="relative flex flex-col w-full p-10 -mt-10 space-y-4 bg-darkViolet rounded-lg md:flex-row md:space-y-0 md:space-x-3"
          >
            <input
              type="text"
          ...
          <div class="flex flex-col items-center justify-between w-full p-6 bg-white rounded-lg md:flex-row">
            ...
            <div class="flex flex-col items-center justify-end flex-1 space-x-4 space-between-y-2 md:flex-row md:space-y-0">
      ...
      <section id="features" class="pb-32 bg-gray-100">
        <div class="relative container flex flex-col items-start px-6 mx-auto md:flex-row md:space-x-7">
          ...
          {/* Vertical Line  */}
          <div class="absolute left-1/2 w-2 h-full -ml-1 bg-cyan md:hidden"></div>
      ...
      <section id="cta" class="py-24 bg-darkViolet">
        <div class="flex flex-col p-2 space-y-6">
          ...
          <button class="px-10 py-5 mx-auto text-2xl font-bold text-white rounded-full bg-cyan hover:bg-cyanLight md:text-base md:py-3 focus:outline-none">
            Get Started
          </button>
        </div>
      </section>
