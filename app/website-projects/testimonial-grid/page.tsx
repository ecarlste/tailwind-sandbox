...
import imageKira from "@/public/images/testimonial-grid/image-kira.jpg";
import imageJeanette from "@/public/images/testimonial-grid/image-jeanette.jpg";
import imagePatrick from "@/public/images/testimonial-grid/image-patrick.jpg";
...
function TestimonialGridSitePage() {
  return (
    <main
      className={`${barlow.variable} ${styles.testimonialGrid} min-h-screen flex items-center`}
    >
      {/* Global Container */}
